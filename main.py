...
def register():
    ...
    #Labels
    Label(register_screen,text="Please enter your details below to register", font=("Calibri",12)).grid(row=0,sticky=N,pady=(0,10))
    Label(register_screen,text="Name", font=("Calibri",12)).grid(row=1,sticky=W,pady=(0,10))
    Label(register_screen,text="Age", font=("Calibri",12)).grid(row=2,sticky=W,pady=(0,10))
    Label(register_screen,text="Gender", font=("Calibri",12)).grid(row=3,sticky=W,pady=(0,10))
    Label(register_screen,text="Password", font=("Calibri",12)).grid(row=4,sticky=W,pady=(0,10))
    notif = Label(register_screen, font=("Calibri",12))
    notif.grid(row=6, sticky=N,pady=(0,10))
    ...
    #Buttons
    Button(register_screen, text="Register", command=finish_reg, font=("Calibri",12)).grid(row=5,sticky=N,pady=(0,10))
    ...
    for name in all_accounts:
        if name == login_name:
            ...
            if login_password == password:
                ...
                #Labels
                Label(account_dashboard, text="Account Dashboard", font=('Calibri',12)).grid(row=0,sticky=N,pady=(0,10))
                Label(account_dashboard, text="Welcome "+name, font=('Calibri',12)).grid(row=1,sticky=N,pady=(0,5))
                ...
                Label(account_dashboard).grid(row=5,sticky=N,pady=(0,10))
                return
            else:
...
def deposit():
    ...
    #Label
    Label(deposit_screen, text="Deposit", font=("Calibri",12)).grid(row=0, sticky=N,pady=(0,10))
    ...
    #Button
    Button(deposit_screen, text="Finish", font=("Calibri",12),command=finish_deposit).grid(row=3,sticky=W,pady=(0,5))
...
def finish_deposit():
    ...
    rounded_balance = round(updated_balance,2)
    file_data = file_data.replace(current_balance, str(rounded_balance))
    file.seek(0)
    file.truncate(0)
...
def withdraw():
    ...
    #Label
    Label(withdraw_screen, text="Withdraw", font=("Calibri",12)).grid(row=0, sticky=N,pady=(0,10))
    ...
    #Button
    Button(withdraw_screen, text="Finish", font=("Calibri",12),command=finish_withdraw).grid(row=3,sticky=W,pady=(0,5))
...
def personal_details():
    ...
    #Labels
    Label(personal_details_screen, text="Personal Details", font=('Calibri',12)).grid(row=0,sticky=N,pady=(0,10))
...
def login():
    ...
    #Labels
    Label(login_screen, text="Login to your account", font=("Calibri", 12)).grid(row=0, sticky=N, pady=(0,10))
    ...
    #Button
    Button(login_screen, text="Login", command=login_session, width=15, font=("Calibri",12)).grid(row=3,sticky=W,pady=(0,5),padx=5)
...
Button(master, text="Register", font=("Calibri", 12), width=20,command=register).grid(row=3, sticky=N, pady=(0, 10))
Button(master, text="Login", font=("Calibri", 12), width=20,command=login).grid(row=4, sticky=N, pady=(0, 10))
